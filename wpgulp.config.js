...
module.exports = {
	...
	// Project options.
	projectURL: 'https://www.valtenna.it/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	bugReport: 'https://www.mapcommunication.it/contatti/', // Where can users report bugs.
	lastTranslator: 'Map Communication <webdesign@mapwork.it>', // Last translator Email ID.
	team: 'Map Communication <webdesign@mapwork.it>', // Team's Email ID.
